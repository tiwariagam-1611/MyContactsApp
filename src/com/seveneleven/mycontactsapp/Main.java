...
// Goal: Allow logged-in users to create, assign, and manage custom tags (e.g., Family, Work, Friends) 
//       for organizing contacts into meaningful categories.
// Use: Provides flexible organization of contacts, enabling quick grouping and retrieval 
//      based on user-defined labels.
// Actor: Logged-in User
// OOP Concepts: Tag class with validation rules, many-to-many relationship between Contact and Tag 
//               for flexible association.
// Design Patterns: Flyweight Pattern for sharing tag instances efficiently across multiple contacts.
// Java Concepts: Set collection for maintaining unique tags, proper equals() and hashCode() 
//                implementations for tag comparison, EnumSet for predefined/common tags.
// Security: Ensures tags are user-specific, preventing unauthorized modification or access 
//           to another user’s tag definitions.
//
// @author Developer
// @version 11.0
